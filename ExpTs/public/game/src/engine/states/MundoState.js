import { GeradorDeGrafos } from "../GeradorDeGrafos.js";
...
export class MundoState {
    mundoUI = new MundoUI();
    geradorDeGrafos = new GeradorDeGrafos();
    STORAGE_KEY = BALANCAMENTO.MUNDO.STORAGE_KEY;
    grafoAtual = {};
    profundidadeAtual = 4;
    tamanhoCamadaAtual = 4;
    noAtualId = null;
    mapaAtual = 0;
    entrar(jogo, app) {
    ...
    carregar() {
        ...
        try {
            ...
            this.grafoAtual = dados.grafoAtual;
