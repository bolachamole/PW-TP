...
const HABILIDADES_DA_GUILDA: Habilidade[] = [
    { nome: "Ataque Preciso", descricao: "Causa dano garantido ignorando parte da defesa.", custoMP: 8, cura: 0, alcance: 2, tipo: 'ataque', som: null },
    { nome: "Fúria da Horda", descricao: "Ataque em área brutal que consome muita mana.", custoMP: 25, cura: 0, alcance: 3, tipo: 'ataquearea', som: null },
