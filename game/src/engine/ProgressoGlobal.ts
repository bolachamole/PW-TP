import { BALANCAMENTO } from "./Balancamento.js";
...
class ProgressoGlobal {
    ...
    public getModificadorCuraPosCombate(): number {
        ...
        return this.nivelPredioCura * BALANCAMENTO.PREDIOS.BONUS_CURA_POR_NIVEL; 
    
    }

    public getModificadorXP(): number {
    
        return 1.0 + (this.nivelPredioTreinamento * BALANCAMENTO.PREDIOS.BONUS_XP_POR_NIVEL);
